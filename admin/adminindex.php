...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_dir)) {
		$qry=mysql_query("insert into categories(photo,category) values('$target_file','$category')");
        ...
        <div class="container-fluid" align="center">
               <table border="0" cellpadding="4" cellspacing="3">
                <form action="#" method="post" enctype="multipart/form-data">
                          <?php echo $_GET['msg'];?>
                          <tr>
                       <td>Enter Category:-<input type="text" name="category" required><br/><br/></td>
                       </tr>
                      <tr>
                      <td>Select image to upload:<input type="file" name="fileToUpload" id="fileToUpload" required><br/><br></td>
                      </tr>
                      <tr>
